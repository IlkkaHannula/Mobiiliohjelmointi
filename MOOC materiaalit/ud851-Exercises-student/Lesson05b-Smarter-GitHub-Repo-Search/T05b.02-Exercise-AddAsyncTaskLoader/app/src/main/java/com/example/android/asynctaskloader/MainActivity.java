...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int GIT_HUB_LOADER_INT = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(GIT_HUB_LOADER_INT, null, this);
    }
    ...
    private void makeGithubSearchQuery() {
        ...
        Loader<String> githubSearchLoader = loaderManager.getLoader(GIT_HUB_LOADER_INT);
        // COMPLETED (23) If the Loader was null, initialize it. Else, restart it.
        if (githubSearchLoader == null) {
            loaderManager.initLoader(GIT_HUB_LOADER_INT, queryBundle, this);
        } else {
            loaderManager.restartLoader(GIT_HUB_LOADER_INT, queryBundle, this);
        }
